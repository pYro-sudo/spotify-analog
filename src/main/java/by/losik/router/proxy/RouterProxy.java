...
public class RouterProxy extends AbstractVerticle {
    ...
    private Uni<Void> setupShardHandler(int shardIndex) {
        ...
        return vertx.eventBus().<JsonObject>consumer(inboundAddress)
                .handler(msg -> {
                    ...
                    forwardMessage(outboundAddress, msg, messageBody);
                })
                .completionHandler()
    ...
    private void forwardMessage(String outboundAddress,
                                io.vertx.mutiny.core.eventbus.Message<JsonObject> originalMsg,
