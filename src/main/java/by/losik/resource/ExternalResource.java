...
public class ExternalResource {
    ...
    public Uni<Response> handleJsonMessage(
        ...
        return authService.validateToken(authHeader)
                .onItem().transformToUni(isValid -> {
                    ...
                    String shardedAddress = getShardedAddress(aggregateId);
    ...
    private String getShardedAddress(String aggregateId) {
        int shardIndex = Math.abs(aggregateId.hashCode()) % inboundShards;
        return "resource.proxy-" + shardIndex;
    }
}